...
class TvShowAdapter : RecyclerView.Adapter<TvShowAdapter.TvShowViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        return TvShowViewHolder(
            ItemTvShowsBinding.inflate(LayoutInflater.from(parent.context),
            parent,
            false
            )
        )
    ...
    RecyclerView.ViewHolder(binding.root) {
        fun bind(tvShow : TvShowEntity){
            with(binding){
                ...
                tvAiringDate.text = itemView.context.resources.getString(R.string.airing_date, tvShow.firstAirDate)
                ...
                itemView.setOnClickListener {
                    ...
                    intent.putExtra(EXTRA_TYPE, tvShow.type)
